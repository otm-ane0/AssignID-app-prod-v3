...
const codeSnippet = `<button id="loginsign-button">Continue with LoginSign</button>
        ...
        >
          ...
          <div style={{
            ...
            <div style={{
              ...
              <Puzzle style={{ width: '24px', height: '24px', color: '#3b82f6' }} />
            </div>
            <div>
              <h2 style={{
                fontSize: '20px',
              ...
              <p style={{
                ...
                Add LoginSign to your application with a few lines of code.
              </p>
            </div>
          </div>
          ...
          <div style={{ padding: '32px', position: 'relative', zIndex: 10 }}>
            ...
            <div style={{
              ...
              <p style={{
                ...
                Keep setup steps accessible in the admin: configure Redirect URIs first.
              </p>
            </div>

            {/* Frontend Snippet Section */}
            <div>
              <label style={{
                display: 'flex',
                alignItems: 'center',
                ...
                <div style={{
                  ...
                  <Code2 style={{ width: '12px', height: '12px', color: '#3b82f6' }} />
                </div>
                Frontend snippet
              </label>
              ...
              <div style={{
                ...
                <pre style={{
                  ...
                  <code>
                    ...
                    <span style={{ color: '#94a3b8' }}>=</span>
                    <span style={{ color: '#34d399' }}>"loginsign-button"</span>
                    <span style={{ color: '#94a3b8' }}>&gt;</span>
                    <span style={{ color: '#e2e8f0' }}>Continue with LoginSign</span>
                    <span style={{ color: '#94a3b8' }}>&lt;/</span>
                    <span style={{ color: '#60a5fa' }}>button</span>
                    <span style={{ color: '#94a3b8' }}>&gt;</span>
                    {'\n\n'}
                    ...
                    <span style={{ color: '#94a3b8' }}>&gt;</span>
                    {'\n  '}
                    <span style={{ color: '#e2e8f0' }}>LoginSign</span>
                    <span style={{ color: '#94a3b8' }}>.</span>
                    <span style={{ color: '#fbbf24' }}>init</span>
                    <span style={{ color: '#94a3b8' }}>(&#123;</span>
                    {'\n    '}
                    <span style={{ color: '#a78bfa' }}>clientId</span>
                    <span style={{ color: '#94a3b8' }}>:</span>
                    {' '}
                    <span style={{ color: '#34d399' }}>'CLIENT_ID'</span>
                    <span style={{ color: '#94a3b8' }}>,</span>
                    {'\n    '}
                    <span style={{ color: '#a78bfa' }}>redirectUri</span>
                    <span style={{ color: '#94a3b8' }}>:</span>
                    {' '}
                    <span style={{ color: '#34d399' }}>'https://yourapp.com/callback'</span>
                    <span style={{ color: '#94a3b8' }}>,</span>
                    {'\n    '}
                    <span style={{ color: '#a78bfa' }}>scope</span>
                    <span style={{ color: '#94a3b8' }}>:</span>
                    {' '}
                    <span style={{ color: '#34d399' }}>'openid email profile'</span>
                    {'\n  '}
                    <span style={{ color: '#94a3b8' }}>&#125;);</span>
                    {'\n\n  '}
                    <span style={{ color: '#e2e8f0' }}>document</span>
                    <span style={{ color: '#94a3b8' }}>.</span>
                    <span style={{ color: '#fbbf24' }}>getElementById</span>
                    <span style={{ color: '#94a3b8' }}>(</span>
                    <span style={{ color: '#34d399' }}>'loginsign-button'</span>
                    <span style={{ color: '#94a3b8' }}>).</span>
                    <span style={{ color: '#a78bfa' }}>onclick</span>
                    {' '}
                    <span style={{ color: '#94a3b8' }}>=</span>
                    {' '}
                    <span style={{ color: '#94a3b8' }}>()</span>
                    ...
                    <span style={{ color: '#e2e8f0' }}>LoginSign</span>
                    <span style={{ color: '#94a3b8' }}>.</span>
                    <span style={{ color: '#fbbf24' }}>login</span>
                    <span style={{ color: '#94a3b8' }}>();</span>
                    {'\n  '}
                    <span style={{ color: '#94a3b8' }}>&#125;;</span>
                    {'\n'}
